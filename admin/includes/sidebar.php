<?php
    ...
    function activeClass($url) {
        return strpos($_SERVER['REQUEST_URI'], $url) !== false ? 'bg-indigo-100 text-indigo-600' : 'text-gray-700 hover:text-indigo-600 hover:bg-gray-200';
    }
?>
<aside id="sidebar"
    ...
    <div>
        ...
        <nav class="space-y-2">
            ...
            <a href="<?= ADMIN_URL ?>/views/customer/index.php"
                class="flex items-center gap-3 p-3 rounded-md font-bold text-lg <?= activeClass('/views/customer/') ?>">
            ...
            <a href="<?= ADMIN_URL ?>/views/account/index.php"
                class="flex items-center gap-3 p-3 rounded-md font-bold text-lg <?= activeClass('/views/account/') ?>">
            ...
            <a href="<?= ADMIN_URL ?>/views/brand/index.php"
                class="flex items-center gap-3 p-3 rounded-md font-bold text-lg <?= activeClass('/views/brand/') ?>">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" class="w-6 h-6">
                    <path
            ...
            <a href="<?= ADMIN_URL ?>/views/category/index.php"
                class="flex items-center gap-3 p-3 rounded-md font-bold text-lg <?= activeClass('/views/category/') ?>">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
            ...
            <a href="<?= ADMIN_URL ?>/views/product/index.php"
                class="flex items-center gap-3 p-3 rounded-md font-bold text-lg <?= activeClass('/views/product/') ?>">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
            ...
            <a href="<?= ADMIN_URL ?>/views/banner/index.php"
                class="flex items-center gap-3 p-3 rounded-md font-bold text-lg <?= activeClass('/views/banner/') ?>">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
