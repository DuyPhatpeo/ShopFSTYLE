...
// Gọi hàm xử lý thêm thương hiệu, nếu thành công sẽ chuyển hướng
// Hàm này được sửa đổi trả về mảng lỗi (rỗng nếu không có lỗi)
$errors = processAddBrand($conn);

// Nếu cần, lấy danh sách thương hiệu (ở đây ví dụ không cần)
?>
