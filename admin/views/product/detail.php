...
$productImages = getProductImagesArray($conn, $product_id);

?>

<main class="container mx-auto p-6">
    <!-- Phần tiêu đề và nút thao tác -->
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <div>
            <h1 class="text-3xl md:text-4xl font-bold text-blue-700">Chi Tiết Sản Phẩm</h1>
            <p class="text-lg text-gray-500 mt-1">ID: <?= htmlspecialchars($product['product_id']) ?></p>
        </div>
    ...
    <div class="bg-white shadow-lg rounded-lg p-6 mb-8">
        ...
        <!-- Ảnh sản phẩm -->
        <div>
            <h2 class="text-lg font-semibold text-gray-800 mb-2">Hình ảnh sản phẩm</h2>
            <div
                class="flex space-x-4 overflow-x-auto py-2 scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-200">
                <?php foreach ($productImages as $img): ?>
                <div class="flex-shrink-0 w-40 h-40 border rounded-xl shadow-md overflow-hidden bg-white">
                    <img src="../../uploads/products/<?= htmlspecialchars($img['image_url']) ?>" alt="Ảnh sản phẩm"
        ...
        <!-- Mô tả -->
        <div class="mt-10">
            <h2 class="text-2xl font-semibold text-gray-800 mb-3">Mô tả sản phẩm</h2>
            <div
                class="bg-gray-50 border border-gray-200 rounded-lg p-4 text-gray-700 whitespace-pre-line max-h-96 overflow-auto leading-relaxed">
