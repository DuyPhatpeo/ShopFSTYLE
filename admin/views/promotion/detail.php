<?php
$pageTitle = "Trang chi tiết khuyến mãi";
...
$promotion = getPromotionDetail($conn, $promotion_id);
if (!$promotion) {
...
<main class="container mx-auto p-6">
    ...
    <div class="flex justify-between items-center mb-4">
        <h1 class="text-3xl font-bold">Chi Tiết Khuyến Mãi</h1>
            ...
            <a href="index.php" class="bg-blue-500 hover:bg-blue-600 text-white p-2 rounded flex items-center"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="w-5 h-5 mr-1" fill="currentColor">
                    <path d="M9.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.2 288 
                        416 288c17.7 0 32-14.3 32-32s-14.3-32-32-32L109.2 224 214.6 118.6c12.5-12.5 
    ...
    <div class="bg-white shadow-md rounded p-6">
        <p class="mb-3">
            <strong>ID:</strong>
            <?= htmlspecialchars($promotion['promotion_id']) ?>
        </p>
        <p class="mb-3">
        ...
        <p class="mb-3">
            ...
            <?= htmlspecialchars($promotion['promotion_code']) ?>
        </p>
        <p class="mb-3">
            <strong>Giảm (%):</strong>
        ...
        <p class="mb-3">
            ...
            <?= htmlspecialchars($promotion['start_date']) ?>
        </p>
        <p class="mb-3">
            <strong>Ngày Kết Thúc:</strong>
            <?= htmlspecialchars($promotion['end_date']) ?>
        </p>
