...
require_once('../../controller/adminController.php'); // File controller tài khoản

// Gọi hàm xử lý thêm tài khoản, nếu thêm thành công hàm sẽ chuyển hướng về index.php
$error = processAddAdmin($conn);
...
<script>
// Hàm chuyển đổi ẩn/hiện mật khẩu cho input được chỉ định bởi ID
