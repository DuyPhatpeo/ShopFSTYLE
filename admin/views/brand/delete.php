...
require_once('../../controller/brandController.php'); // File xử lý thương hiệu
...
<main class="container mx-auto p-6">
    ...
    <div class="flex justify-between items-center mb-4">
        <div>
            <h1 class="text-3xl font-bold">Xóa Thương Hiệu</h1>
            <p class="text-sm text-gray-500">ID thương hiệu: <?= htmlspecialchars($brand['brand_id']) ?></p>
        </div>
    ...
    <!-- Khung xác nhận xoá với thông tin ảnh nếu có -->
    <div class="bg-white shadow rounded p-6">
        ...
        <div class="mb-4">
            <img src="../../../<?= htmlspecialchars($brand['image_url']) ?>"
                alt="<?= htmlspecialchars($brand['brand_name']) ?>" class="object-contain max-w-xs border rounded">
        </div>
        <?php endif; ?>
