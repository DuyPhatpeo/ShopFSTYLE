...
// Gọi hàm xử lý thêm vai trò, nếu thêm thành công sẽ chuyển hướng
// Hàm processAddRole() trả về mảng lỗi (rỗng nếu không có lỗi)
$errors = processAddRole($conn);
?>
...
<main class="container mx-auto p-6">
    ...
    <form method="POST" action="">
        <!-- Chia form thành 2 cột (ở đây chỉ có trường mô tả tuỳ chọn bên cột phải) -->
