...
require_once('../../controller/roleController.php'); // File xử lý role
...
<main class="container mx-auto p-6">
    ...
    <div class="flex justify-between items-center mb-4">
        <div>
            <h1 class="text-3xl font-bold">Xóa Vai Trò</h1>
            <p class="text-sm text-gray-500">ID vai trò: <?= htmlspecialchars($role['role_id']) ?></p>
        </div>
