        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            ...
            <div class="flex md:hidden justify-between items-center">
                ...
                <div class="flex items-center space-x-4">
                    <button id="menu-toggle" class="text-gray-600 hover:text-black focus:outline-none">
                        <img src="assets/icons/menu.svg" alt="menu" class="w-8 h-8" />
                    </button>
                ...
                <div class="flex items-center space-x-2">
                    <img src="assets/images/logo-fstyle.png" alt="logo" class="w-12 h-12 object-contain" />
                </div>

                <!-- Cart & Profile -->
                <div class="flex items-center space-x-4">
                    <button class="text-gray-600 hover:text-black">
                        <img src="assets/icons/bag-shopping.svg" alt="bag-shopping" class="w-8 h-8" />
                    </button>
            ...
            <div class="hidden md:flex justify-between items-center">
                ...
                <div class="flex items-center space-x-3 cursor-pointer">
                    <img src="assets/images/logo-fstyle.png" alt="logo" class="w-20 lg:w-24 object-contain" />
                </div>
